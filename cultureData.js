...
const CULTURE_DATA = [
  ...
  {
    id: "netherlands_windmill",
    country: "Netherlands",
    image: "custom/windmill.jpeg",
    hint: "风车",
    content:
      "风车是荷兰最著名的国家标志。荷兰地势低洼，全国约四分之一的土地低于海平面。荷兰人利用风车抽水排水，把低地改造成良田，因此有'上帝创造了世界，荷兰人创造了荷兰'的说法。如今风车已成为荷兰的文化象征，小孩堤防的19座风车群还被列为世界文化遗产呢！",
  },
  {
    id: "netherlands_tulip",
    country: "Netherlands",
    image: "custom/tulip.jpeg",
    hint: "郁金香",
    content:
      "郁金香是荷兰的国花，也是荷兰最亮丽的名片。17世纪时，荷兰曾掀起'郁金香热'，人们疯狂抢购郁金香球茎，价格甚至比黄金还贵！如今荷兰每年生产约90亿颗郁金香球茎，供应全世界。每年春天的库肯霍夫公园，数百万朵郁金香同时绽放，美得像个童话世界。",
  },
  {
    id: "netherlands_clog",
    country: "Netherlands",
    image: "custom/clog.jpeg",
    hint: "木鞋",
    content:
      "木鞋是荷兰最具特色的传统工艺品，已有800多年的历史。荷兰地势低洼、泥土潮湿，木鞋坚固防水，非常适合农作时穿着。过去的荷兰农民几乎人人都穿木鞋。如今木鞋已成为荷兰的标志之一，每年吸引大量游客购买作为纪念品，也是荷兰人订婚时送给对方的传统信物。",
  },
  {
    id: "switzerland_alps",
    country: "Switzerland",
    image: "custom/alps.jpeg",
    hint: "阿尔卑斯山",
    content:
      "阿尔卑斯山是欧洲最著名、最壮丽的山脉，而瑞士拥有阿尔卑斯山最精华的部分——超过60%的瑞士国土位于阿尔卑斯山区。瑞士境内有48座海拔超过4000米的山峰，包括著名的马特洪峰，还有欧洲最大的阿莱奇冰川。阿尔卑斯山是瑞士自然风光的灵魂，也是户外运动爱好者的天堂。",
  },
  {
    id: "switzerland_swiss_army_knife",
    country: "Switzerland",
    image: "custom/swiss_army_knife.jpeg",
    hint: "瑞士军刀",
    content:
      "瑞士军刀是瑞士精密制造的全球名片，1891年由维氏公司推出，最初是为瑞士军队设计的多功能工具。一把小小的军刀集成了刀片、剪刀、开瓶器、螺丝刀等十几种功能，体现了瑞士工匠的精湛技艺。红色的刀柄上镶有白色十字标志，已成为瑞士品质的象征，风靡全世界。",
  },
  {
    id: "switzerland_watch",
    country: "Switzerland",
    image: "custom/watch.jpeg",
    hint: "钟表",
    content:
      "瑞士钟表是世界顶级制表工艺的代名词。16世纪，受宗教改革影响，大批法国和意大利的制表师移居瑞士，将精湛的制表技艺带到了日内瓦和汝拉山区。经过数百年的传承，瑞士手表以精准、可靠和优雅著称，诞生了百达翡丽、劳力士、欧米茄等享誉世界的品牌。'瑞士制造'就是品质的保证。",
  },
  {
    id: "denmark_little_mermaid",
    country: "Denmark",
    image: "custom/LittleMermaid.jpeg",
    hint: "小美人鱼雕像",
    content:
      "小美人鱼雕像坐落在丹麦首都哥本哈根的海边，她已经在这里静静地坐了100多年。她来自安徒生爷爷写的童话《海的女儿》，为了心爱的王子，她甘愿化作海上的泡沫。虽然雕像小小的，只有1米多高，但她是丹麦最温柔的象征，全世界的小朋友都听过她的故事。",
  },
  {
    id: "denmark_lego",
    country: "Denmark",
    image: "custom/LEGOLAND.jpeg",
    hint: "乐高乐园",
    content:
      "乐高积木诞生在丹麦的一个小镇——比隆。乐高爷爷用一块块小小的塑料积木，搭出了全世界的城堡、汽车和宇宙飞船。在丹麦的乐高乐园里，所有东西都是用乐高拼成的，连小火车和海盗船都是！乐高这个名字来自丹麦语“Leg Godt”，意思是“玩得开心”，这可是每个孩子都懂的快乐语言。",
  },
  {
    id: "denmark_andersen",
    country: "Denmark",
    image: "custom/Andersen.jpeg",
    hint: "安徒生童话",
    content:
      "安徒生是全世界最会讲童话故事的爷爷，他写了《丑小鸭》《卖火柴的小女孩》《皇帝的新装》和《海的女儿》等等。安徒生爷爷小时候家里很穷，但他用想象力给全世界的孩子造了一座大大的故事宫殿。在丹麦的欧登塞，还有他的故居和博物馆，就像走进了童话世界一样。",
  },
  {
    id: "iceland_blue_lagoon",
    country: "Iceland",
    image: "custom/BlueLagoon.jpeg",
    hint: "蓝湖温泉",
    content:
      "蓝湖是冰岛最著名的地热温泉，湖水是漂亮的奶蓝色，像一大碗倒入牛奶的蓝莓果汁！湖水是从地底下的火山岩里冒出来的，带着很多矿物，热乎乎的。人们在蓝湖里泡温泉时，还会把白色的硅泥抹在脸上当面膜，对皮肤特别好。蓝湖周围是大片黑色的火山石，远远望去就像到了月球表面一样神奇。",
  },
  {
    id: "iceland_jokulsarlon",
    country: "Iceland",
    image: "custom/Jokulsarlon.jpeg",
    hint: "杰古沙龙冰河湖",
    content:
      "杰古沙龙冰河湖是冰岛最梦幻的地方之一。巨大的冰川会“咔嚓”一声裂开，掉进湖里变成一块块蓝色的浮冰，在阳光照射下闪闪发光，像撒在海面上的大钻石。有时还会有海豹趴在冰块上晒太阳，懒洋洋地摇尾巴。这里的冰块有的像水晶，有的像蓝宝石，是大自然送给冰岛最清凉的礼物。",
  },
  {
    id: "iceland_black_sand_beach",
    country: "Iceland",
    image: "custom/BlackSandBeach.jpeg",
    hint: "黑沙滩",
    content:
      "冰岛的黑沙滩和普通沙滩完全不一样——这里的沙子是黑色的！因为它们是火山爆发时，滚烫的熔岩被海水冲碎后变成的黑沙。白色的巨浪拍打在黑黑的沙滩上，黑白分明，特别壮观。沙滩旁边还有一根根像管风琴一样的黑色石柱，是火山岩浆冷却时形成的。这种奇特的风景，全地球可不多见呢。",
  },
];
